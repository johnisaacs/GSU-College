...
function add_custom_jquery() {
	...
	wp_enqueue_style('print-styles', '//cms.georgiasouthern.edu/~gsu/web_templates/CORE/css/wp/print.css', false, null,'print');
	wp_enqueue_style('local-styles', get_template_directory_uri() . '/style.css', false, null,'all');
	wp_enqueue_style('responsive-college', '//cms.georgiasouthern.edu/~gsu/web_templates/CORE/css/wp/responsive-college.css', false, null,'all');	
